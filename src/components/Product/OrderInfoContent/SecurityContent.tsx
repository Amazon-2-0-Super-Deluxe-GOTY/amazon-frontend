  ...
  return (
    <div className="grow space-y-4 lg:space-y-6">
      <p className="text-sm sm:text-base">
        You buy safely in Perry. Here you will learn about your rights after
        purchase.
      </p>
      <Separator orientation="horizontal" />
      <div className="space-y-3">
        <h3 className="text-heading-3 font-semibold">Complaint</h3>
        <p className="text-sm sm:text-base">
          Seller is responsible for defective goods within{" "}
          <span className="font-semibold">1 year</span> from the moment of
          delivery.
        </p>
        <h3 className="text-heading-3 font-semibold flex justify-between items-center">
      ...
      <Separator orientation="horizontal" />
      <div className="space-y-3">
        <h3 className="text-heading-3 font-semibold">Guarantee</h3>
        <p className="text-sm sm:text-base">
