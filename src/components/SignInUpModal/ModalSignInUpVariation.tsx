...
const ModalLogIn = ({ changeModal } : { changeModal: (modal:string) => void }) => {
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="w-full">
        ...
        <div className="flex w-full justify-center items-center">
          <span className="text-base max-sm:text-sm">Don&apos;t have an account?</span>
          <Button variant={"link"} className="px-1" onClick={() => {changeModal("signup")}}>Sign up</Button>
        </div>
      </div>
    </div>
  );
...
const ModalSignUp = ({ changeModal } : { changeModal: (modal:string) => void }) => {
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div>
        ...
        <div className="flex w-full justify-center items-center">
          ...
          <Button variant={"link"} className="px-1" onClick={() => {changeModal("login")}}>Log in</Button>
        </div>
      </div>
    </div>
  );
...
const ModalSignUpCode = ({ changeModal } : { changeModal: (modal:string) => void }) => {
  return (
    <div className="w-full h-full">
      <div className="flex justify-start">
        <Button variant={"ghost"} onClick={() => {changeModal("signup")}} className="absolute p-3 pl-1">
          <ChevronLeft />
