  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="rounded-lg" hideClose>
        <DialogHeader>
          <span className="text-xl md:text-2xl font-medium mb-4">Change photo</span>
          <Separator />
        </DialogHeader>
        <div className="mt-4">
...
export const ChangeNameModal = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="rounded-lg" hideClose>
        <DialogHeader>
          <span className="text-xl md:text-2xl font-medium mb-4 text-left">Change name</span>
          <Separator />
        </DialogHeader>
        <div className="mt-4">
...
export const ChangeEmailModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="rounded-lg" hideClose>
        <DialogHeader>
          <span className="text-xl md:text-2xl font-medium md:mb-4 mb-3 text-left">Change email</span>
          <Separator />
        </DialogHeader>
        <div className="flex flex-col gap-3 md:mt-4">
          <span className="flex md:text-base text-sm">Your current email is <p className="text-blue-400 ml-1 md:text-base text-sm">{email}</p>.</span>
          <span className="md:text-base text-sm">To change it, enter a new email, then click “Send code” and enter it in corresponding prompt.</span>
        </div>
        <div className="mt-4">
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="max-w-[464px] rounded-lg" hideClose>
        <DialogHeader className="flex flex-col justify-center items-center">
          <span className="text-xl md:text-3xl font-semibold md:mb-4 mb-3">Log out?</span>
          <Separator />
          <span className="text-base md:text-xl text-center pt-5 md:px-4">You will log out of your account on this device</span>
        </DialogHeader>
        <div className="flex justify-between items-center gap-3 md:mt-5 mt-1">
...
export const DeleteAccountModal = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="max-w-[464px] rounded-lg" hideClose>
        <DialogHeader className="flex flex-col justify-center items-center">
          <span className="text-xl md:text-3xl font-semibold md:mb-4 mb-3">Delete account?</span>
          <Separator />
          <div className="flex flex-col justify-center items-center md:text-xl text-base text-center md:py-6 pt-[14px] md:px-4 gap-5">
